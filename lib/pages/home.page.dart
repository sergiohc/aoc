...
class _HomePageState extends State<HomePage> {
        ...
        child:  ListView(
          children: <Widget>[
            ...
            if (_completed ) 
              ...
              SubmitForm( alcController: _alcController, gasController: _gasController, submitFunc: calculate,   busy: _busy),
          ],
        ),
      ),
    );
  ...
  Future calculate(){
    double alc = double.parse(
      _alcController.text.replaceAll(new RegExp(r'[,.]'), '')) / 100 ;
    
    double gas = double.parse(
      _gasController.text.replaceAll(new RegExp(r'[,.]'), '')) / 100 ;
